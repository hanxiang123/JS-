- [JavaScript](#javascript)
  - [五.面向对象](#五面向对象)
    - [创建对象的方式](#创建对象的方式)
      - [调用系统内置的构造函数创建对象](#调用系统内置的构造函数创建对象)
      - [字面量的方式创建一个对象](#字面量的方式创建一个对象)
      - [使用工厂函数的方式创建对象](#使用工厂函数的方式创建对象)
      - [使用自定义构造函数创建对象](#使用自定义构造函数创建对象)
    - [构造函数详解](#构造函数详解)
      - [构造函数的基本使用](#构造函数的基本使用)
      - [使用构造函数创建一个对象](#使用构造函数创建一个对象)
    - [原型](#原型)
      - [prototype](#prototype)
      - [\_\_proto\_\_](#__proto__)
    - [原型链](#原型链)
      - [一个对象所属的构造函数](#一个对象所属的构造函数)
